    ...
    if (localStorage.getItem('data') != null) {
        ...
        for (i = 0; i < data.length; i++) {
            ...
            $('#content_wishlist').append(
                ...
                '"><img src="' + image +
                '" width="90" height="90" alt="National Fresh"></a></div><div class="left-info"><div class="product-title"><a href="desc_product/' + id + '" class="product-name">' +
                name +
...
function add_wishlish(wish_id) {
    ...
    if (matches.length) {
        ...
        $('#content_wishlist').append(
            '<li><div class="minicart-item"><div class="thumb"><a href="desc_product/' + newItem.id + '"><img src="' + newItem
            .image +
